...
bool Gameplay::init()
{
    ...
    player->setPosition(Vec2(ctinter::vsize.width / 2, ctinter::vsize.height / 2));
    ...
    auto listener = EventListenerAcceleration::create([=](Acceleration* acc, Event* event) {
        ...
        FIX_POS(curpos.x, PLAYER_RADIUS, ctinter::vsize.width - PLAYER_RADIUS);
        FIX_POS(curpos.y, PLAYER_RADIUS, ctinter::vsize.height - PLAYER_RADIUS);
